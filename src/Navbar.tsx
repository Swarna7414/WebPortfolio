...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-black text-white h-15 flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 z-10">
      ...
      <h1 className="text-2xl font-cursive ml-15 sm:ml-7 md:ml-8 lg:ml-10 xl:ml-12 scale-x-150 italic hover:text-blue-500">
        Sai Sankar Swarna
      </h1>
      ...
      <ul className="hidden md:flex flex-row justify-between items-center gap-12 transition duration-300 ease-in-out">
        <Link to="/home"><li className="hover:text-blue-500">Home</li></Link>
        <Link to="/skillsandtechnology"><li className="hover:text-blue-500">Skill & Technology</li></Link>
